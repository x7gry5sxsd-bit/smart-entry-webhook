...
# Pump.fun API - reply_count, socials, created_timestamp
# No API key required
try:
...
if not ca:
    empty = '\n=== ON-CHAIN ===\n'
    empty += 'RUG_LEVEL: UNKNOWN\nRUG_SCORE: 0\nRUG_FLAGS: N/A\nLP_LOCKED: 100\n'
    empty += 'DEX_STATUS: UNAVAILABLE\nVOL_5M: 0\nVOL_1H: 0\nVOL_ACCEL: 0\n'
    empty += 'BS_ONCHAIN: 0\nBUYS_5M: 0\nSELLS_5M: 0\nPRICE_5M: 0\nPRICE_1H: 0\n'
    empty += 'LIQUIDITY_USD: 0\nTXNS_5M_TOTAL: 0\n'
    empty += 'REPLY_COUNT: 0\nHAS_TWITTER: 0\nHAS_TELEGRAM: 0\n'
    empty += 'HAS_WEBSITE: 0\nSOCIALS_COUNT: 0\nWAS_KOH: 0\n'
    empty += '==============='
